    ...
    try {
      ...
      if (response.success) {
        ...
        toast.success("Étudiant créé avec succès", {
          description: `L'étudiant ${data.contactDetails.firstName} ${data.contactDetails.lastName} a été créé avec succès.`,
          duration: 3000,
        ...
        // Génération du PDF dans un try-catch séparé pour ne pas bloquer la redirection
        try {
          const doc = new jsPDF();
          ...
          doc.text(`Pays: ${result.address.country}`, margin, margin + 160);
          ...
          // Ne pas afficher de toast d'erreur pour ne pas perturber l'expérience utilisateur
        }
      } else {
