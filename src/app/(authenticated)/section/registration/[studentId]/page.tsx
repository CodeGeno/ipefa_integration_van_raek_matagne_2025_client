    ...
    try {
      ...
      if (response.success) {
        toast({
          ...
          description: "L'étudiant a été inscrit à la section avec succès",
        });
      } else {
        toast({
          variant: "destructive",
  ...
  return (
    <div className="container mx-auto py-10 space-y-6">
      <CardHeader>
        ...
        <CardDescription>Détails de l'étudiant à inscrire</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex flex-wrap gap-6">
          ...
          <div className="flex-1 min-w-[250px] space-y-2">
            ...
            <p className="text-lg font-medium">{student?.identifier}</p>
          </div>
        </div>
      </CardContent>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        {selectedSectionType === SectionTypeEnum.BACHELOR && (
                          <>
                            <SelectItem value="1">Bloc 1</SelectItem>
                            <SelectItem value="2">Bloc 2</SelectItem>
                            <SelectItem value="3">Bloc 3</SelectItem>
                          </>
                        )}
                        {selectedSectionType === SectionTypeEnum.MASTER && (
                          <>
